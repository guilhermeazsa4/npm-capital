...
export function Footer() {
  ...
  return (
    <footer className="site-footer gold-surface relative overflow-hidden border-t border-[#FFE39A]/70 px-5 py-6 text-black lg:px-8 lg:py-7">
      ...
      <div className="site-footer-inner relative z-10 mx-auto max-w-[1220px]">
