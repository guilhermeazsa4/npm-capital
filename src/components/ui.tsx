...
import { ArrowRight, ChevronRight, FileText, ScrollText } from "lucide-react";
...
function FloatingWhatsAppIcon() {
  return (
    <a
      ...
      className="floating-green-button whatsapp-animate whatsapp-shake group inline-flex h-14 w-14 items-center justify-center overflow-hidden rounded-[18px] text-white active:scale-95"
    >
