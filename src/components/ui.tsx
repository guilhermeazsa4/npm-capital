...
import { SOCIAL, WHATSAPP_URL } from "@/lib/constants";
...
export function WhatsAppButton({
  ...
  return (
    <a
      ...
      className={`group relative inline-flex min-h-12 items-center justify-center gap-3 overflow-hidden rounded-[16px] border border-[#7CFF9C]/55 bg-[#1FAF67]/92 px-6 py-3 text-sm font-black text-white shadow-[0_0_0_1px_rgba(255,255,255,0.12),0_0_22px_rgba(34,197,94,0.18),0_14px_36px_rgba(31,175,103,0.32),inset_0_1px_0_rgba(255,255,255,0.34),inset_0_-1px_0_rgba(0,80,40,0.14)] backdrop-blur-xl transition-all hover:-translate-y-0.5 hover:border-[#A7FFBA]/72 hover:bg-[#22C55E]/94 hover:shadow-[0_0_0_1px_rgba(255,255,255,0.16),0_0_28px_rgba(34,197,94,0.26),0_18px_44px_rgba(31,175,103,0.4),inset_0_1px_0_rgba(255,255,255,0.4)] active:scale-[0.98] ${className ?? ""}`}
    >
...
function FloatingWhatsAppIcon() {
  return (
    <div className="group/whatsapp relative flex flex-col items-center">
      <div className="pointer-events-none absolute bottom-full right-0 flex -translate-y-2 flex-col items-center gap-3 pb-3 opacity-0 transition-all duration-200 group-hover/whatsapp:pointer-events-auto group-hover/whatsapp:translate-y-0 group-hover/whatsapp:opacity-100">
        <a
          href={SOCIAL.instagram}
          target="_blank"
          rel="noopener noreferrer"
          aria-label="Instagram"
          className="floating-instagram-button inline-flex h-14 w-14 items-center justify-center overflow-hidden rounded-[18px] text-white active:scale-95"
        >
          <InstagramIcon className="relative z-10 h-6 w-6" />
        </a>
        <a
          ...
          rel="noopener noreferrer"
          aria-label="Facebook"
          className="floating-facebook-button inline-flex h-14 w-14 items-center justify-center overflow-hidden rounded-[18px] text-white active:scale-95"
        >
          <FacebookIcon className="relative z-10 h-6 w-6" />
        </a>
      </div>
      ...
      <a
        ...
        className="floating-green-button whatsapp-animate whatsapp-shake inline-flex h-14 w-14 items-center justify-center overflow-hidden rounded-[18px] text-white active:scale-95"
      >
